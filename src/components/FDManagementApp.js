...
import { Trash2, Edit, Plus, RefreshCw, Download, Upload } from 'lucide-react';
      ...
      <div className="bg-white p-6 rounded-lg shadow-md mb-4">
        <div className="flex justify-between items-center mb-4">
          ...
          <div className="flex gap-3">
            ...
            <label className="bg-purple-600 text-white py-2 px-4 rounded hover:bg-purple-700 flex items-center gap-2 cursor-pointer">
